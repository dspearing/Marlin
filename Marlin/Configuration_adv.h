...
#define ASSISTED_TRAMMING
  ...
  #define TRAMMING_POINT_XY { {  20, 20 }, { 330,  20 }, { 330, 330 }, { 20, 330 } }
...
#define DISABLE_INACTIVE_Z treu  // Set to false if the nozzle will fall down on your printed part when print has finished.
